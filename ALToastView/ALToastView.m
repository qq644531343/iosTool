...
- (id)initWithText:(NSString *)text {
	if ((self = [self initWithFrame:CGRectZero])) {
		// Add corner radius
		self.backgroundColor = [[UIColor colorWithARGB:0x000000] colorWithAlphaComponent:0.6];
        ...
        if ([[UIDevice currentDevice].systemVersion floatValue] < 6.0f) {
            textsize = [text sizeWithFont:_textLabel.font constrainedToSize:CGSizeMake(7*13, 100) lineBreakMode:UILineBreakModeCharacterWrap];
        }else {
